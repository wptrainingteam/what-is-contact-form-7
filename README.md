...
Tags are codes representing elements of the form, for example [text your-subject] or [text* your-name]. The tags can be added by clicking on the tags button when editing the form. The basic parts that compose a tag can be found in [Using Tags](#using-tags) section.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTMyNjE1Mzc5LC0xNjExNDAzNjM1LDE3NT
U3MDkxOTMsMTc2NDMwMjcxMCwtMTIwOTYyMzI4XX0=
-->