...
>![]**Tip**: There are also some options available if you want to validate your data input for it to fit some requirements, i.e. phone number format, i.e. [Jquery Validation For Contact Form 7](https://wordpress.org/plugins/jquery-validation-for-contact-form-7/). Alter the code to look like this:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMzAwMzgzODcsMTc2NDMwMjcxMCwtMT
IwOTYyMzI4XX0=
-->